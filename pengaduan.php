    ...
    <article class="pengaduan-konten">
      ...
      <form class="pengaduan-form" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        ...
        <div class="pengaduan-group">
          ...
          <input name="no_hp" type="text" class="pengaduan-input" placeholder="Contoh: 081234567890" required minlength="10">
        </div>
        ...
        <div class="pengaduan-group">
          ...
          <input name="alamat" type="text" class="pengaduan-input" placeholder="Contoh: jalan air rt 1" required minlength="10">

        <div class="pengaduan-group">
          <label class="pengaduan-label">Foto *</label>
          <input name="foto" type="file" class="pengaduan-file" accept="image/*" required>
        ...
        <div class="pengaduan-group">
          ...
          <textarea name="deskripsi" class="pengaduan-textarea"
            placeholder="Tuliskan kronologi atau detail masalah..." required minlength="10"></textarea>
        </div>
