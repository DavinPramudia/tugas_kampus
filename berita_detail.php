...
if (mysqli_num_rows($query) == 0) {
  echo "<h2 style='text-align:center;'>Berita tidak ditemukan.</h2>";
  exit();
}
...
<head>
  ...
  <title><?php echo htmlspecialchars($berita['judul']); ?> - Berita Desa Baturusa</title>
  ...
  <div class="container">
    ...
    <nav class="breadcrumbs">
      <ol>
        ...
        <li><a href="berita.php">Berita</a></li>
        <li class="current"><?php echo htmlspecialchars($berita['judul']); ?></li>
      </ol>
    </nav>
  </div>
</div>
...
<section class="detail-berita-section">
  <div class="detail-container">
    ...
    <article class="detail-berita-card">
      ...
      <small class="tanggal">
        Dipublikasikan pada: <?php echo date('d F Y', strtotime($berita['tanggal'] ?? 'now')); ?>
      </small>

      <?php if (!empty($berita['gambar']) && file_exists("admin/assets/images/berita/" . $berita['gambar'])): ?>
        <div class="detail-gambar-wrapper">
          <img src="admin/assets/images/berita/<?php echo htmlspecialchars($berita['gambar']); ?>" 
      ...
      <div class="kembali-btn">
        <a href="berita.php" class="btn-berita">&laquo; Kembali ke Daftar Berita</a>
      </div>
    </article>
