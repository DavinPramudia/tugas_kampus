...
<section class="umum-section">
  ...
  <div class="umum-kiri">
    <article class="umum-konten-teks">
      <h2>Struktur Organisasi Desa Baturusa</h2>

      <p>
        Berikut merupakan struktur organisasi dan tata kerja pemerintahan Desa Baturusa serta struktur Badan Permusyawaratan Desa (BPD) Tahun 2024.
      </p>
      <img src="./image/STRUKTUR ORGANISASI DAN TATA KERJA PEMERINTAHAN DESA BATURUSA  TAHUN 2024.drawio.jpg" 
           alt="Struktur Organisasi dan Tata Kerja Pemerintahan Desa Baturusa Tahun 2024" 
           style="width:100%; border-radius:10px; margin-top:10px;">
      <img src="./image/STRUKTUR BADAN PERMUSYAWARATAN DESA DESA BATURUSA TAHUN 2024.jpg" 
           alt="Struktur Badan Permusyawaratan Desa (BPD) Desa Baturusa Tahun 2024" 
           style="width:100%; border-radius:10px; margin-top:10px;">
    </article>
  </div>
